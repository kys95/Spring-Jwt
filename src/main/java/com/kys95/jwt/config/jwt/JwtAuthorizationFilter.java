...
/**
 * security가 filter를 가지고 있는데 그 필터중에 BasicAuthenticationFilter 라는 것이 있음
 * 권한이나 인증이 필요한 특정 주소를 요청했을 때 위 filter를 무조건 타게 되어있음
 * 만약에 권한이나 인증이 필요한 주소가 아닐 경우 위 filter를 타지 않음.
 */
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    //인증이나 권한이 필요한 주소요청이 있을 때 해당 filter를 타게 됨
    @Override
...
//        System.out.println("jwtHeader:" + jwtHeader);
        ...
        //Jwt token 검증을 하여 정상적인 사용자인지 확인
